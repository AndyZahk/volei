...
function podiumMedalhas(){
    if(pontos === 3){
        ...
        textContent= "Resultado da competição: 3 pontos é BRONZE! ";
    }
    else if(pontos === 4){
        caixaPrincipal.style.backgroundImage = "url('img/prata.png')";
        textContent = "Resultado da competição: 4 pontos é PRATA!";
    }
    else if( pontos === 5){
        caixaPrincipal.style.backgroundImage = "url('img/ouro.png')";
        textContent = "Resultado da competição: 5 pontos é OURO!";
    }
    else if( pontos < 3){
        caixaPrincipal.style.backgroundImage = "url('img/perdeu.png')";
        textContent = "Resultado da competição: PERDEU!"; 
    }
}
